    ...
    private void init(AttributeSet attrs) {
        ...
        if (a != null) {
            ...
            for (int i = 0; i < count; i++) {
                index = a.getIndex(i);
                if (index == R.styleable.TextImage_TextImage_height) {
                    height = a.getDimensionPixelSize(index, -1);
                } else if (index == R.styleable.TextImage_TextImage_width) {
                    width = a.getDimensionPixelSize(index, -1);
                } else if (index == R.styleable.TextImage_TextImage_drawable) {
                    mDrawable = a.getResourceId(index, -1);
                } else if (index == R.styleable.TextImage_TextImage_seat) {
